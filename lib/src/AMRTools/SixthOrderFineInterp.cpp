...
#include "SixthOrderFineInterp.H"
#include "NamespaceHeader.H"
//////////////////////////////////////////////////////////////////////////////
// Constructor - set up some defaults
SixthOrderFineInterp::SixthOrderFineInterp()
{
  m_defined = false;
}
...
void SixthOrderFineInterp::define(/// layout at this level
...
//////////////////////////////////////////////////////////////////////////////
const BaseFab<IntVect>& SixthOrderFineInterp::getStencil(const DataIterator&    a_dit) const
{
...
//////////////////////////////////////////////////////////////////////////////
const BaseFab<IntVect>& SixthOrderFineInterp::getStencil(const DataIndex&    a_dind) const
{
  CH_assert(m_defined);
...
//////////////////////////////////////////////////////////////////////////////
LevelData<FArrayBox>& SixthOrderFineInterp::coarsenedFineData()
{
  CH_assert(m_defined);
  return m_coarseData;
}
...
//////////////////////////////////////////////////////////////////////////////
SixthOrderPatchInterp& SixthOrderFineInterp::patchInterp()
{
  CH_assert(m_defined);
...
//////////////////////////////////////////////////////////////////////////////
void SixthOrderFineInterp::interpToFine(
...
//////////////////////////////////////////////////////////////////////////////
void SixthOrderFineInterp::interpOnPatch(
                                          /// interpolated solution on this level
                                          FArrayBox&            a_fine,
                                          /// coarse solution
